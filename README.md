...
Production-ready AWS infrastructure managing **75+ cloud resources** across **2 environments** for **CI/CD automation**. Built from scratch over **5 months** to demonstrate enterprise-grade DevOps practices, modern AWS services (2023-2024), security hardening, and infrastructure as code principles. Every line of infrastructure code written, debugged, and deployed hands-on.
...
## 🎯 Project Overview
![Diagram 2](https://github.com/user-attachments/assets/80b009ca-496d-4821-86e3-fc61654e2f77)
